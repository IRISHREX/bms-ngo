...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "volunteer.form.fatherName": "Father's Name",
    "volunteer.form.motherName": "Mother's Name",
    "volunteer.form.dob": "Date of Birth",
    "volunteer.form.gender": "Gender",
    "volunteer.form.male": "Male",
    "volunteer.form.female": "Female",
    "volunteer.form.other": "Other",
    "volunteer.form.age": "Age",
    "volunteer.form.maritalStatus": "Marital Status",
    "volunteer.form.married": "Married",
    "volunteer.form.unmarried": "Unmarried",
    "volunteer.form.contactAddr": "Contact & Address",
    "volunteer.form.mobileNo": "Mobile Number",
    "volunteer.form.whatsappNo": "WhatsApp Number",
    "volunteer.form.email": "Email ID",
    "volunteer.form.fullAddress": "Full Address",
    "volunteer.form.village": "Village",
    "volunteer.form.postOffice": "Post Office",
    "volunteer.form.policeStation": "Police Station",
    "volunteer.form.district": "District",
    "volunteer.form.pinCode": "PIN Code",
    "volunteer.form.eduOcc": "Education & Occupation",
    "volunteer.form.education": "Educational Qualification",
    "volunteer.form.edu.primary": "Primary",
    "volunteer.form.edu.madhyamik": "Madhyamik",
    "volunteer.form.edu.hs": "Higher Secondary",
    "volunteer.form.edu.graduate": "Graduate",
    "volunteer.form.edu.pg": "Post Graduate",
    "volunteer.form.occupation": "Occupation",
    "volunteer.form.aadhaarNo": "Aadhaar Number",
    "volunteer.form.panNo": "PAN Number",
    "volunteer.form.memDetails": "Membership Details",
    "volunteer.form.whyJoin": "Why do you want to join the Trust?",
    "volunteer.form.socialInterest": "Area of Social Work Interest",
    "volunteer.form.interest.blood": "Blood Donation",
    "volunteer.form.interest.health": "Health Service",
    "volunteer.form.interest.edu": "Education",
    "volunteer.form.interest.help": "Helping Poor & Helpless People",
    "volunteer.form.interest.child": "Child Welfare",
    "volunteer.form.interest.women": "Women Welfare",
    "volunteer.form.interest.agri": "Agriculture",
    "volunteer.form.interest.env": "Environment",
    "volunteer.form.interest.disaster": "Disaster Relief",
    "volunteer.form.prevExp": "Previous Social Work Experience",
    "volunteer.form.memType": "Membership Type",
    "volunteer.form.mem.general": "General Member",
    "volunteer.form.mem.active": "Active Member",
    "volunteer.form.mem.volunteer": "Volunteer",
    "volunteer.form.mem.life": "Life Member",
    "volunteer.form.docs": "Documents",
    "volunteer.form.photo": "Passport Size Photograph",
    "volunteer.form.aadhaarCopy": "Aadhaar Card Copy",
    "volunteer.form.addrProof": "Address Proof",
    "volunteer.form.otherDoc": "Other Document",
    "volunteer.form.declaration": "Declaration",
    "volunteer.form.declarationText": "I hereby declare that the information provided in this application is true and correct to the best of my knowledge. I agree to abide by the rules and regulations of Hope Foundation Trust and support its social welfare activities to the best of my ability.",
  ...
  bn: {
    ...
    "volunteer.form.title": "সদস্যপদ আবেদন ফর্ম",
    "volunteer.form.personalInfo": "ব্যক্তিগত তথ্য",
    "volunteer.form.fullName": "পূর্ণ নাম",
    "volunteer.form.fatherName": "পিতার নাম",
    "volunteer.form.motherName": "মাতার নাম",
    "volunteer.form.dob": "জন্ম তারিখ",
    "volunteer.form.gender": "লিঙ্গ",
    "volunteer.form.male": "পুরুষ",
    "volunteer.form.female": "মহিলা",
    "volunteer.form.other": "অন্যান্য",
    "volunteer.form.age": "বয়স",
    "volunteer.form.maritalStatus": "বৈবাহিক অবস্থা",
    "volunteer.form.married": "বিবাহিত",
    "volunteer.form.unmarried": "অবিবাহিত",
    "volunteer.form.contactAddr": "যোগাযোগ ও ঠিকানা",
    "volunteer.form.mobileNo": "মোবাইল নম্বর",
    "volunteer.form.whatsappNo": "হোয়াটসঅ্যাপ নম্বর",
    "volunteer.form.email": "ই-মেইল আইডি",
    "volunteer.form.fullAddress": "সম্পূর্ণ ঠিকানা",
    "volunteer.form.village": "গ্রাম",
    "volunteer.form.postOffice": "ডাকঘর",
    "volunteer.form.policeStation": "থানা",
    "volunteer.form.district": "জেলা",
    "volunteer.form.pinCode": "পিন কোড",
    "volunteer.form.eduOcc": "শিক্ষা ও পেশা",
    "volunteer.form.education": "শিক্ষাগত যোগ্যতা",
    "volunteer.form.edu.primary": "প্রাথমিক",
    "volunteer.form.edu.madhyamik": "মাধ্যমিক",
    "volunteer.form.edu.hs": "উচ্চ মাধ্যমিক",
    "volunteer.form.edu.graduate": "স্নাতক",
    "volunteer.form.edu.pg": "স্নাতকোত্তর",
    "volunteer.form.occupation": "পেশা",
    "volunteer.form.aadhaarNo": "আধার নম্বর",
    "volunteer.form.panNo": "PAN নম্বর",
    "volunteer.form.memDetails": "সদস্যপদের তথ্য",
    "volunteer.form.whyJoin": "আপনি কেন ট্রাস্টের সদস্য হতে চান?",
    "volunteer.form.socialInterest": "কোন ধরনের সমাজসেবায় আগ্রহী?",
    "volunteer.form.interest.blood": "রক্তদান",
    "volunteer.form.interest.health": "স্বাস্থ্যসেবা",
    "volunteer.form.interest.edu": "শিক্ষা",
    "volunteer.form.interest.help": "দরিদ্র ও অসহায় মানুষের সহায়তা",
    "volunteer.form.interest.child": "শিশু কল্যাণ",
    "volunteer.form.interest.women": "নারী কল্যাণ",
    "volunteer.form.interest.agri": "কৃষি",
    "volunteer.form.interest.env": "পরিবেশ",
    "volunteer.form.interest.disaster": "দুর্যোগকালীন ত্রাণ",
    "volunteer.form.prevExp": "পূর্বের সমাজসেবার অভিজ্ঞতা",
    "volunteer.form.memType": "সদস্যপদের ধরন",
    "volunteer.form.mem.general": "সাধারণ সদস্য",
    "volunteer.form.mem.active": "সক্রিয় সদস্য",
    "volunteer.form.mem.volunteer": "স্বেচ্ছাসেবক",
    "volunteer.form.mem.life": "আজীবন সদস্য",
    "volunteer.form.docs": "প্রয়োজনীয় নথি",
    "volunteer.form.photo": "পাসপোর্ট সাইজ ছবি",
    "volunteer.form.aadhaarCopy": "আধার কার্ডের কপি",
    "volunteer.form.addrProof": "ঠিকানার প্রমাণপত্র",
    "volunteer.form.otherDoc": "অন্যান্য নথি",
    "volunteer.form.declaration": "ঘোষণা",
    "volunteer.form.declarationText": "আমি ঘোষণা করছি যে, এই আবেদনপত্রে প্রদত্ত সমস্ত তথ্য আমার জ্ঞান ও বিশ্বাস অনুযায়ী সঠিক। আমি Hope Foundation Trust-এর নিয়ম ও শর্ত মেনে চলব এবং ট্রাস্টের মানবিক ও সমাজসেবামূলক কার্যক্রমে যথাসম্ভব সহযোগিতা করব।",
  },
  hi: {
    "lang.en": "English",
    "lang.bn": "বাংলা",
